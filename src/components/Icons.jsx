// Iconos SVG minimalistas (sin dependencias externas) para mantener el bundle liviano.
...
export function WhatsAppIcon({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.198.297-.767.966-.94 1.164-.173.198-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.15-.174.198-.298.298-.497.099-.198.05-.372-.025-.521-.075-.15-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.148.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z" />
      <path d="M12.004 2C6.486 2 2.01 6.477 2.01 11.996c0 1.995.523 3.856 1.437 5.478L2 22l4.657-1.427a9.94 9.94 0 0 0 5.347 1.55h.004c5.518 0 9.994-4.478 9.994-9.997C22.002 6.477 17.522 2 12.004 2zm0 18.06h-.003a8.05 8.05 0 0 1-4.107-1.126l-.295-.175-3.05.934.973-2.973-.192-.305a8.03 8.03 0 0 1-1.24-4.319c0-4.43 3.607-8.036 8.043-8.036 2.148 0 4.166.837 5.684 2.357a7.983 7.983 0 0 1 2.35 5.684c0 4.43-3.606 8.036-8.163 8.036z" />
    </svg>
  )
}
...
export function TiktokIcon({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M16.6 5.82a4.28 4.28 0 0 1-3.05-3.05h-2.86v13.2a2.6 2.6 0 1 1-2.6-2.6c.14 0 .28.01.41.03V10.5a5.5 5.5 0 1 0 5.05 5.48V9.8a7.14 7.14 0 0 0 4.05 1.26V8.2a4.28 4.28 0 0 1-1-2.38z" />
    </svg>
  )
}
...
export function TwitchIcon({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M4.3 2 3 5.6v14.2h4.9V22l3-2.2h3.6l5.6-5.6V2H4.3zm14 11-3.4 3.4h-3.6L8.6 19v-2.6H5.4V3.4h13v9.6z" />
      <path d="M15.7 7h-1.6v4.7h1.6V7zm-4.4 0H9.7v4.7h1.6V7z" />
    </svg>
  )
}
...
export function TagIcon({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M20.59 13.41 11 3.83a2 2 0 0 0-1.42-.59H4a2 2 0 0 0-2 2v5.59a2 2 0 0 0 .59 1.42l9.58 9.58a2 2 0 0 0 2.83 0l6.59-6.59a2 2 0 0 0 0-2.83z" />
...
export function TruckIcon({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function WrenchIcon({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M14.7 6.3a4 4 0 0 0-5.6 5.2L2 18.6 5.4 22l7.1-7.1a4 4 0 0 0 5.2-5.6l-2.5 2.5-2.6-.6-.6-2.6z" />
    </svg>
  )
}
